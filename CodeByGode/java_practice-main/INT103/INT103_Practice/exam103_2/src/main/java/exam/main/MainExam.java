...
public class MainExam {
    ...
    private static final ToCompare[] cmps = {
        new ToCompare(054, "65130500054"),
        new ToCompare(-7, "Seven"),
        new ToCompare(-2, "Two"),
        new ToCompare(-9, "Nine"),
        new ToCompare(-3, "Three") };
    
    // replace YOUR_FIRSTNAME with your firstname.
    // replace YOUR_LASTNAME with your lastname.
    private static final ToBeLambda[] lds = {
        new ToBeLambda("Phuttinan", "Phaksaweang"),
